...
<body>
				...
				<ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{route('variation')}}">Add Variation</a></li>
                            <li><a href="{{route('product.list')}}"> Porduct List</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
    ...
    ***********************************-->
	...
	<script src="{{asset('/dashboard_assetvendor/bootstrap-datetimepicker/js/moment.js')}}"></script>
	<script src="{{asset('/dashboard_assetvendor/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js')}}"></script>
