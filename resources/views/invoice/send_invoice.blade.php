...
<html lang="en">
  ...
  <body>
    <header class="clearfix">
      <div id="logo">
        <img src="https://i.postimg.cc/RF9fpstq/logo.png">
      </div>
      <div id="company">
    ...
    <main>
      <div id="details" class="clearfix">
        <div id="client">
          ...
          <div class="email"><a >{{ App\Models\BillingDetails::where('order_id', $order_id)->first()->mobile_number }}</a></div>
        </div>
        <div id="invoice">
          <h3>INVOICE-{{ $order_id }} </h3>
          <div class="date">Date of Invoice: {{ App\Models\Order::where('order_id', $order_id)->first()->created_at }}</div>
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="unit">{{ $product->rel_to_product->after_discount }}</td>
            <td class="qty">{{$product->quantity  }}</td>
            <td class="total">{{ $product->rel_to_product->after_discount *  $product->quantity }}</td>
          </tr>
