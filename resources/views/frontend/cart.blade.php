				...
				<div class="container">
					...
					<div class="row justify-content-center">
						<div class="col-12 col-md-10 col-lg-8 col-xl-6 text-center">
							...
							<!-- Icon -->
							<div class="p-4 d-inline-flex align-items-center justify-content-center text-success mx-auto mb-4"><img width="100" src="https://media.istockphoto.com/id/1352766190/vector/shopaholic-woman-running-with-an-empty-shopping-cart.jpg?b=1&s=612x612&w=0&k=20&c=Hla3NveEWq0AAnTlFgyMi95dEFqv_yJjPBDxBX15tFo=" alt=""></div>
							<!-- Heading -->
							<h2 class="mb-2 ft-bold">Your Cart Is Empty!</h2>
							<!-- Text -->
							
							<!-- Button -->
							<a class="btn btn-dark" href="{{ route('index') }}">Shop Here</a>
						</div>
					</div>
                    ...
                    <div class="col-12 col-lg-12">
                        ...
                        <form class="mb-7 mb-md-0" action="" method="GET">
                            ...
                            <div class="row form-row">
                                <div class="col">
                                  <input class="form-control" name="coupon_code" type="text" value="{{ @$_GET['coupon_code'] }}"  placeholder="Enter coupon code*">
                                @if ($message)
                  ...
                  <div class="card-body">
                    ...
                    <ul class="list-group list-group-sm list-group-flush-y list-group-flush-x">
                      <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                        <span>Subtotal</span> <span class="ml-auto text-dark ft-medium">৳ {{ number_format($subtotal) }}</span>
                      </li>
                      <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                        <span>Discount</span> <span class="ml-auto text-dark ft-medium">
                            -{{ ($type == 1)?$subtotal*$discount/100:$discount }} ৳</span>
                      </li>
                      <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                        @php
                            if($type == 1){
                        ...
                        @endphp
                        <span>Total</span> <span class="ml-auto text-dark ft-medium">৳ {{ number_format($total) }}</span>
                      </li>
