        ...
        <div class="row justify-content-between">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="number" id="phone" name="mobile_number" class="form-control" placeholder="Mobile Number" />
                            </div>
                        </div>
            ...
            <div class="col-12 col-lg-4 col-md-12">
                <div class="d-block mb-3">
                    <h5 class="mb-4">Order Items ({{ $total_count }})</h5>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col d-flex align-items-center">
                                    <div class="cart_single_caption pl-2">
                                        ...
                                        <h4 class="fs-md ft-medium mb-3 lh-1">{{ $cart->rel_to_product->after_discount }} X {{ $cart->quantity }}</h4>
                                    </div>
                                </div>
                            </div>
                        </li>
                ...
                <div class="card mb-4 gray">
                    ...
                    <ul class="list-group list-group-sm list-group-flush-y list-group-flush-x">
                        ...
                        <span>Subtotal</span> <span class="ml-auto text-dark ft-medium" data-subtotal="{{ session('total') }}" id="subtotal">৳ {{ number_format(session('total')) }}</span>
                        </li>
                        <li class="list-group-item d-flex text-dark fs-sm ft-regular">
