					...
					<div class="row">
						...
						<div class="col-xl-5 col-lg-6 col-md-12 col-sm-12">
							...
							<div class="currency-selector dropdown js-dropdown float-right mr-3">
								...
								{{-- <a href="#" class="text-muted medium"><i class="lni lni-user mr-1"></i>{{ Auth::guard('customerlogin')->user()->name }}</a> --}}
							</div>
							@else
							<div class="currency-selector dropdown js-dropdown float-right mr-3">
								<a href="{{ route('customer.login') }}" class="text-muted medium"><i class="lni lni-user mr-1"></i>Sign In / Register</a>
							</div>
							@endauth
					...
					<div class="right-ch-sideBar">
							...
							<div class="d-flex align-items-center justify-content-between br-bottom px-3 py-3">
								<div class="cart_single d-flex align-items-center">
									<div class="cart_selected_single_thumb">
										<a href="{{ route('details', $wishlist->rel_to_product->slug) }}"><img src="{{ asset('uploads/product/preview') }}/{{ $wishlist->rel_to_product->preview }}" width="60" class="img-fluid" alt="" /></a>
									</div>
									<div class="cart_single_caption pl-2">
										<h4 class="product_title fs-sm ft-medium mb-0 lh-1">{{ $wishlist->rel_to_product->product_name }}</h4>
										<p class="mb-2"><span class="text-dark ft-medium small"></span>, <span class="text-dark small"></span></p>
						...
						<div class="cart_action px-3 py-3">
							<div class="form-group">
								<a href="{{ route('show.wishlist') }}" type="button" class="btn d-block full-width btn-dark-light">View Whishlist</a>
							</div>
						</div>
							...
							@foreach (App\Models\Cart::where('customer_id', Auth::guard('customerlogin')->id())->get() as $cart)
								...
								<div class="cart_single d-flex align-items-center">
									...
									<div class="cart_single_caption pl-2">
										...
										<p class="mb-2"><span class="text-dark ft-medium small">QTY:{{ $cart->quantity }}</span></p>
