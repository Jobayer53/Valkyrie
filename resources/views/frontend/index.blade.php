					...
					<div class="row">
						...
						<div class="col-xl-3 col-lg-3 col-md-12 col-sm-12">
							<div class="killore-new-block-link border mb-3 mt-3">
								...
								<div style="font-family: fontawesome;" class="killore--block-link-content">
									<ul>
                                        @foreach ($categories as  $category)
                                        
										<li><a href="javascript:void(0);"><i class="{{ $category->icon }}" aria-hidden="true"></i>{{ $category->category_name }}</a></li>
                                        @endforeach
						...
						<div class="col-xl-9 col-lg-9 col-md-12 col-sm-12">
							<div class="home-slider auto-slider mb-3 mt-3">
								...
								<!-- Slide -->
								<div data-background-image="{{ asset('frontend/assets/img/light-banner-1.png') }}" class="item">
									<div class="container">
										<div class="row">
											<div class="col-md-12">
								...
								<!-- Slide -->
								<div data-background-image="{{ asset('frontend/assets/img/light-banner-2.png') }}" class="item">
									<div class="container">
										<div class="row">
											<div class="col-md-12">
												<div class="home-slider-container">
								...
								<!-- Slide -->
								<div data-background-image="{{ asset('frontend/assets/img/light-banner-3.png') }}" class="item">
									<div class="container">
										<div class="row">
											<div class="col-md-12">
												<div class="home-slider-container">
					...
					<div class="row">
						<div class="col-xl-12 col-lg-12 col-md-12">
							<div class="smart-brand">
								...
								<div class="single-brnads text-center">
									<h3 style="border-right: 1px solid #031424">{{ $product->brand }}</h3>
								</div>
								@endforeach
					...
					<div class="row align-items-center justify-content-center">
						...
						<div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-4">
							<div class="cats_side_wrap text-center mx-auto mb-3">
								<div class="sl_cat_01"><div class="d-inline-flex align-items-center justify-content-center circle" style="border: 1px solid black; border-radius: 100%;font-size: 30px; width:80px; height:65px; line-height:70px; "><a href="javascript:void(0);" class="d-block">
									<i style="font-family: fontawesome;  " class="{{ $category->icon }}"></i>
								</a></div></div>
